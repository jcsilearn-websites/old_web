      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-20 space-y-12 sm:space-y-16 lg:space-y-20">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl border border-white/20">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Our Mission</h2>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Close the gap between academic learning and professional readiness</p>
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  <div className="w-2 h-2 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-xs sm:text-sm text-gray-600">Provide practical skills needed for today's job market</p>
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  <div className="w-2 h-2 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-xs sm:text-sm text-gray-600">Foster innovation, confidence, and continuous development</p>
                </div>
              </div>
            </div>
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Our Vision</h2>
        ...
        <section className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="relative order-first lg:order-last">
            ...
            <div className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-3 sm:p-4 text-white">
              <p className="font-semibold text-xs sm:text-sm lg:text-base">Leadership Team</p>
            </div>
          </div>
          <div>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Meet Our Founders</h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed mb-4 sm:mb-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-3 sm:p-4 border border-pink-200">
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-2">— Founder, JCS iLearn</p>
              </div>
            </div>
            <div className="mt-4 sm:mt-6">
              <Link 
        ...
        <section className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-6 sm:p-8 lg:p-12 text-white text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6">🚀 Ready to Start Your Journey?</h2>
