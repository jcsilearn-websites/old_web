      ...
      <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Industry-Relevant Skills</h4>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Expert-Led Training</h4>
                    <p className="text-xs sm:text-sm lg:text-base text-gray-600">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Practical Learning</h4>
                    <p className="text-xs sm:text-sm lg:text-base text-gray-600">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Career Acceleration</h4>
                    <p className="text-xs sm:text-sm lg:text-base text-gray-600">
            ...
            >
              ...
              >
                ...
                <svg width="16" height="16" fill="none" viewBox="0 0 20 20" className="w-4 h-4 sm:w-5 sm:h-5">
                  <path
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl border border-white/20">
            ...
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2">Soft Skills</h4>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl border border-white/20">
            ...
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2">Technical Skills</h4>
            <p className="text-xs sm:text-sm text-gray-600">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl border border-white/20">
            ...
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2">Aptitude Training</h4>
            <p className="text-xs sm:text-sm text-gray-600">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl border border-white/20">
            ...
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2">Career Guidance</h4>
            <p className="text-xs sm:text-sm text-gray-600">
