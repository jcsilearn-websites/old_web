      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-6 max-w-xl h-full">
          ...
          >
            ...
            Strong Industry Connections: Our extensive network with leading companies and organizations helps us stay updated with industry trends and provides valuable placement opportunities for our trainees
          </motion.p>
          <motion.div
            initial="hidden"
            whileInView="visible"
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.7 }}
          variants={fadeUp}
          transition={{ duration: 0.7, type: "spring", stiffness: 60, damping: 18, delay: 0.15 }}
